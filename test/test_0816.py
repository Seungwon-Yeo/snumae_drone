...
class Controller:
    ...
    def __init__(self):
        ...
        self.sp_glob.coordinate_frame = 6  # FRAME_GLOBAL_REL_INT
    ...
    def updateSp_glob(self):
        ...
        # self.sp_glob.latitude = 37.4540084
        # self.sp_glob.longitude = 126.9517742
        self.sp_glob.altitude = 5
...
class fcuModes:
    ...
    def setTakeoff(self, global_pos):
        ...
        try:
            ...
            takeoffService(latitude=global_pos.x, longitude=global_pos.y, altitude=2.5)
...
def main():
    ...
    last = rospy.get_time()
    while not rospy.is_shutdown() and (last - start) < 3.0:     
        # # Update sp_glob to Target's GPS
        cnt.updateSp_glob()
        cnt.drone_GPS_record.append(cnt.global_pos)
